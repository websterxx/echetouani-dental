      ...
      <div className="container py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-1">
            <span className="font-semibold font-headline">Cabinet Echetouani Charron</span>
        ...
        <div className="mt-8 text-center text-sm">
          <p>&copy; {new Date().getFullYear()} Cabinet Echetouani Charron. Tous droits réservés.</p>
        </div>
      </div>
    </footer>
  );
