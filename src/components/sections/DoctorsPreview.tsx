      ...
      <div className="container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-4xl mx-auto">
          {doctors.map((doctor, index) => (
            <Link key={index} href="/doctor-office" className="group relative block rounded-lg overflow-hidden aspect-[4/5] transition-transform hover:scale-105 shadow-2xl">
              <Image
                src={doctor.image}
                alt={doctor.lastName}
                fill
              ...
              <div className="absolute bottom-0 left-0 p-6 text-white">
                <h3 className="text-2xl font-bold">DR. ECHETOUANI</h3>
