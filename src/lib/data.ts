...
import { Ambulance ,Smile, Sparkles, Anchor, Briefcase, ShieldCheck, HeartHandshake, Accessibility } from 'lucide-react';
...
export const services: Service[] = [
  {
    ...
    description: 'Maintenez une santé bucco-dentaire optimale grâce à nos contrôles dentaires complets et à nos services de nettoyage.',
  ...
  },
  {
    ...
    description: 'Obtenez un sourire parfaitement aligné avec nos traitements orthodontiques modernes, y compris les appareils dentaires et les aligneurs transparents.',
  ...
  },
  {
    ...
    description: 'Restaurez votre sourire avec des implants dentaires durables et d`apparence naturelle, la référence pour les dents manquantes.',
    longDescription: 'Les implants dentaires sont la solution la plus avancée et la plus durable pour remplacer les dents manquantes. Un petit tenon en titane est placé chirurgicalement dans l\'os de la mâchoire, agissant comme une racine artificielle. Une fois guéri, il est surmonté d\'une couronne sur mesure qui ressemble et fonctionne comme une dent naturelle. Les implants vous permettent de manger, de parler et de sourire en toute confiance, tout en préservant l\'os de la mâchoire.',
    image: 'https://placehold.co/600x400.png',
  ...
  },
  {
    ...
    description: 'Éclaircissez votre sourire avec nos services de blanchiment des dents professionnels pour un look éblouissant et confiant.',
  ...
  },
  {
    ...
    description: 'Protégez et restaurez les dents endommagées avec nos couronnes dentaires de haute qualité, fabriquées sur mesure.',
  ...
  },
  {
    ...
    description: 'Des soins dentaires doux et amicaux pour les enfants afin d`assurer une vie de sourires sains.',
...
export const values = [
    {
        ...
        description: 'Nous adhérons aux normes les plus élevées de conduite professionnelle et d`excellence clinique.'
    },
    {
        icon: ShieldCheck,
        title: 'Hygiène',
        description: 'Votre sécurité est notre priorité. Nous maintenons des protocoles de stérilisation et d`hygiène stricts.'
    },
    {
        icon: HeartHandshake,
        title: 'Soins Personnalisés',
        description: 'Chaque patient est unique. Nous proposons des plans de traitement sur mesure pour répondre à vos besoins individuels.'
    },
    {
        icon: Accessibility,
        title: 'Accessibilité',
        description: 'Notre cabinet est équipé pour accueillir les personnes à mobilité réduite afin de garantir l`accès aux soins pour tous.'
    }
];

export const testimonials = [
    {
        quote: "La meilleure expérience dentaire que j'aie jamais eue. L'équipe est incroyablement professionnelle et attentionne. Mon sourire n'a jamais été aussi beau !",
        name: 'Amina K.',
        location: 'Paris, France',
    },
    {
        quote: "Les docteurs Echetouani sont de vrais artistes. Ils ont transformé mon sourire avec des implants dentaires, et je ne pourrais pas être plus heureux du résultat.",
        name: 'Youssef B.',
        location: 'Lyon, France',
    },
    {
        quote: 'Un cabinet magnifique et propre. Le personnel m`a mis à l`aise dès mon arrivée. Fortement recommandé !',
        name: 'Fatima Z.',
        location: 'Marseille, France',
    },
    {
        quote: 'Mes enfants ont hâte de leurs rendez-vous chez le dentiste ici. Le Dr. Ahmed est fantastique avec les enfants !',
        name: 'David L.',
        location: 'Paris, France',
    },
];
...
export const cases = [
    {
        ...
        description: 'Relooking complet du sourire à l`aide de facettes en porcelaine sur mesure pour corriger la décoloration et le mauvais alignement.',
        beforeImage: '/facettesEnporcelaineAvant.png',
        afterImage: '/facettesEnporcelaineApres.png',
        beforeImageHint: 'yellow teeth',
        afterImageHint: 'white smile',
    },
    {
        title: 'Alignement Orthodontique',
        description: 'Six mois de traitement orthodontique pour redresser les dents et améliorer la fonction de morsure.',
        beforeImage: '/allignementAvant.png',
        afterImage: '/allignementApres.png',
        beforeImageHint: 'crooked teeth',
        afterImageHint: 'straight teeth',
    },
    {
        title: 'Implant',
        description: 'Restauration d`une arcade complète avec des implants dentaires, offrant une solution stable et esthétique.',
        beforeImage: '/implantAvant.png',
        afterImage: '/implantApres.png',
        beforeImageHint: 'missing teeth',
        afterImageHint: 'dental implants',
    },
    {
        title: 'Blanchiment des Dents',
        description: 'Traitement de blanchiment des dents professionnel en cabinet pour un sourire considérablement plus éclatant.',
